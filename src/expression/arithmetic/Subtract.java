...
public class Subtract extends AbstractBinaryOperations<ArithmeticExpression> implements ArithmeticExpression {
    public Subtract(ArithmeticExpression first, ArithmeticExpression second) {
        super(first, second);
    }
